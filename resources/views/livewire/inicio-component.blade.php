        ...
        <div class="row">
            <div class="col-md-6 hero-content" id="hero">
                ...
                <div class="form-group">
                    @if ($showCreditos == 1)
                    <button class="btn btn-primary" wire:click="$emit('showCredito')">Consultar crédito</button>
                    @else
                        <button class="btn btn-primary" wire:click="$emit('hideCredito')">Consultar crédito</button>
                    @endif
                        ...
                        <div
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card"
                                            style="border:0px; border-radius:2px; box-shadow: 0px 0px 5px rgba(0,0,0.2); padding:10px">
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-1">
                                                                <label for="telefono"
                                                                    class="text-muted">Teléfono</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-2">
                                                                <label class="text-muted">Pagarías {{ $cuotas }}
                                                                    cuotas mensuales por un valor aproximado: </label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-2">
                                                                ...
                                                                <span
                                                                    class="text-muted">{{ $porcentajeIntereses }}%</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group mt-4">
                                                        <button wire:click="$emit('enviarSolicitud')"
                                                            class="btn btn-success">Solicitar crédito</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card"
                                            style="border:0px; border-radius:2px; padding:5px; box-shadow: 0px 0px 5px rgba(0,0,0.2)">
                                            <div class="card-header" style="background-color:white;">
                                                                ...
                                                                <table class="table table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($prestamos as $prestamo)
                                                                            <tr>
                                                                                <td>{{ $prestamo->cliente->nombre ?? '' }}
                                                                                </td>
                                                                                <td>${{ $prestamo->montoprestamo }}</td>
                                                                                <td>
                                                                                    <button
                                                                                        wire:click.prevent="abonarCuota({{ $prestamo->id }})"
                                                                                        class="btn btn-warning btn-sm">Abonar</button>
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
                                                                    </tbody>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mt-2">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        disabled wire:model="nombreCliente">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">   
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card"
                                            style="border:0px; border-radius:2px; padding:5px; box-shadow: 0px 0px 5px rgba(0,0,0.2)">
                                            <div class="card-header" style="background-color:white;">
                                                <h5 class="card-title">Créditos |Consultar</h5>
                                                <div class="row">
                                                    <div class="col-md-12" style="display:inline-block">
                                                        <input type="text" class="form-control"
                                                            wire:model="cedula"
                                                                    ...
                                                                    <tbody>
                                                                        @foreach ($prestamos as $prestamo)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <button
                                                                                        wire:click.prevent="showCuotasPrestamo({{ $prestamo->id }})"
                                                                                        class="btn btn-warning btn-sm">Cuotas</button>
                                                                                </td>
                                                                            </tr>
                                                                        @endforeach
                                                                    </tbody>
